...
import { PREFER_CACHE, ElysiumPoolAccountFetcherInterface } from "../../../network/public/fetcher";
...
export class PoolGraphBuilder {
   ...
   * @param cache - {@link ElysiumPoolAccountFetcherInterface} to use for fetching pool data
