...
export class PoolUtil {
  ...
  public static getFeeRate(feeRate: number): Percentage {
    /**
     * Smart Contract comment: https://github.com/orca-so/pool/blob/main/programs/pool/src/state/pool.rs#L9-L11
  ...
  public static getProtocolFeeRate(protocolFeeRate: number): Percentage {
    /**
     * Smart Contract comment: https://github.com/orca-so/pool/blob/main/programs/pool/src/state/pool.rs#L13-L14
